...
def parse(trailhead, lines):
    ...
    while cont:
        ...
        if lines[pos[0]][pos[1]] == 9:
            ...
            if lines[surroundings[0][0]][surroundings[0][1]] == lines[pos[0]][pos[1]] + 1:
                pos = surroundings[0]
        else:
            output = 0
            for position in surroundings:
                if (lines[position[0]][position[1]] == lines[pos[0]][pos[1]] + 1):
                    output += parse(position, lines)
            return output
